 ...
 * user interface for John Conway's GameOfLife.
 * 
 * This was written using swing, not JavaFX.
 * 
 * @author Rick Mercer
 */
	...
	public GameOfLifeGUI() {
		...
		for (int r = 0; r < ROWS; r++)
			for (int c = 0; c < COLS; c++) {
				...
				cells[r][c].setBorder(BorderFactory.createMatteBorder(1, 1, 1, 1, Color.LIGHT_GRAY));
		...
		p.add(new JLabel(" Delay in milliseconds ", JLabel.CENTER), BorderLayout.SOUTH);
